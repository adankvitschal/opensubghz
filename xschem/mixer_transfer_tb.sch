...
C {devices/vsource.sym} -220 -30 0 1 {name=VRF value="dc 0 AC 1 sin(0 vin1_amplitude \{carrier_freq+base_freq\})"}
C {devices/vsource.sym} 0 140 3 0 {name=VLO value="dc 0 sin(0 600m carrier_freq)"}
C {devices/res.sym} -160 -70 1 0 {name=R2
value=50
footprint=1206
device=resistor
m=1}
C {devices/vsource.sym} 60 170 0 0 {name=VLOm value=0.9}
C {devices/gnd.sym} 60 200 0 0 {name=l3 lab=GND}
C {devices/vsource.sym} -220 140 0 0 {name=VRFm value=0.9}
...
*.endc
"}
C {devices/lab_pin.sym} -30 -220 0 1 {name=l9 sig_type=std_logic lab=vbias}
...
.param bias_width=6
.param mixer_biasfactor=10
.param mixer_m23width=52.05
.param mixer_m23fingers=9
.param mixer_m4567width=25.95
.param mixer_m4567fingers=5
.param mixer_rw=5.73
.param mixer_rl=45.9
"}
...
C {efabless-opencore/xschem/bias.sym} -230 -200 0 0 {name=X1}
...
C {devices/vsource.sym} -220 30 0 1 {name=VRFaux value="dc 0 sin(0 vin2_amplitude \{carrier_freq+base_freq+delta_freq\})"}
